...
class Observation(BaseModel):
    ...
    profit_margin: Optional[float] = Field(None, description="Profit margin signal")
    cost_efficiency: Optional[float] = Field(None, description="Cost efficiency signal")
    growth_signal: Optional[float] = Field(None, description="Growth signal")
    profit_trend: Optional[float] = Field(None, description="Recent profit trend")
    last_reward: Optional[float] = Field(None, description="Previous step reward")
    risk_level: Optional[float] = Field(None, description="Current risk indicator")
    strategic_health: Optional[float] = Field(None, description="Strategic health signal")
    growth_momentum: Optional[float] = Field(None, description="Growth momentum signal")
    decision_quality: Optional[str] = Field(None, description="Assessment of the current decision")
    final_summary: Optional[Dict[str, Any]] = Field(None, description="Final episode summary when done")
    ...
    reward: float = Field(default=0.0, ge=-1.0, le=1.0, description="Reward for this step")
